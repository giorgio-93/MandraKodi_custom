...
def getSource():
    startUrl = "https://raw.githubusercontent.com/giorgio-93/MandraKodi_custom/refs/heads/main/disclaimer.json"
...
def underMaintMsg():
    ...
    strToRet +='"fanart":"https://sfondo.info/i/original/e/e/a/4613.jpg","info":"Addon Under Maintenance"},'
    ...
    strToRet +='"fanart":"https://sfondo.info/i/original/e/e/a/4613.jpg","info":"Send Log"}'
    strToRet +=']}'
...
def callReolver(metodo, parametro):
    ...
    fanart="https://sfondo.info/i/original/e/e/a/4613.jpg"
        ...
        for rowTmp in arrTmp:
            if (rowTmp != ""):
                ...
                if (oldGroup != group):
                    ...
                    strJson += '"fanart": "https://sfondo.info/i/original/e/e/a/4613.jpg",'
                ...
                strJsonNew += '"fanart":"https://sfondo.info/i/original/e/e/a/4613.jpg",'
                link = arrRow[2]
            ...
            if action == 'getExtData':
                ...
                if not (keyboard.isConfirmed() == False):
                    ...
                    if not (userInput == ''):
                        ...
                        logga("NO INPUT")
                        mesNoInput='{"SetViewMode":"500","items":[{"title":"[COLOR red]NO INPUT[/COLOR]","link":"ignore","thumbnail":"https://e7.pngegg.com/pngimages/56/148/png-clipart-computer-icons-wrong-miscellaneous-blue-thumbnail.png","fanart":"https://sfondo.info/i/original/e/e/a/4613.jpg","info":"NO INPUT"}]}'
